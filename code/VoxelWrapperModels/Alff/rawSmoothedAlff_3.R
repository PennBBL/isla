#' ---
#' title: "Multivariate Voxelwise `gam()`: Raw Smoothed Alff (Size: 3)"
...
if (all(purrr::map_lgl(covariates_df$path, file.exists))){
  ...
  covariates <- "/data/jux/BBL/projects/isla/data/sandbox/voxelwise_gam_covariates_rawSmoothedAlff_3.rds" %T>%
